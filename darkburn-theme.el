...
;;;;; basic coloring
   ...
   `(default ((t (:foreground ,darkburn-fg :background ,darkburn-bg))))
...
;;;;; isearch
   ...
   `(menu ((t (:foreground ,darkburn-fg :background ,darkburn-bg))))
...
;;;;; auto-complete
   ...
   `(popup-isearch-match ((t (:background ,darkburn-bg :foreground ,darkburn-fg))))
;;;;; android mode
...
;;;;; ert
   `(ert-test-result-expected ((t (:foreground ,darkburn-green+4 :background ,darkburn-bg))))
   `(ert-test-result-unexpected ((t (:foreground ,darkburn-red :background ,darkburn-bg))))
;;;;; eshell
...
;;;;; erc
   ...
   `(erc-prompt-face ((t (:foreground ,darkburn-orange :background ,darkburn-bg :weight bold))))
...
;;;;; helm
   ...
   `(helm-separator ((t (:foreground ,darkburn-red :background ,darkburn-bg))))
   `(helm-time-zone-current ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg))))
   `(helm-time-zone-home ((t (:foreground ,darkburn-red :background ,darkburn-bg))))
   `(helm-bookmark-addressbook ((t (:foreground ,darkburn-orange :background ,darkburn-bg))))
   `(helm-bookmark-directory ((t (:foreground nil :background nil :inherit helm-ff-directory))))
   `(helm-bookmark-file ((t (:foreground nil :background nil :inherit helm-ff-file))))
   `(helm-bookmark-gnus ((t (:foreground ,darkburn-magenta :background ,darkburn-bg))))
   `(helm-bookmark-info ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg))))
   `(helm-bookmark-man ((t (:foreground ,darkburn-yellow :background ,darkburn-bg))))
   `(helm-bookmark-w3m ((t (:foreground ,darkburn-magenta :background ,darkburn-bg))))
   `(helm-buffer-not-saved ((t (:foreground ,darkburn-red :background ,darkburn-bg))))
   `(helm-buffer-process ((t (:foreground ,darkburn-cyan :background ,darkburn-bg))))
   `(helm-buffer-saved-out ((t (:foreground ,darkburn-fg :background ,darkburn-bg))))
   `(helm-buffer-size ((t (:foreground ,darkburn-fg-1 :background ,darkburn-bg))))
   `(helm-ff-directory ((t (:foreground ,darkburn-cyan :background ,darkburn-bg :weight bold))))
   `(helm-ff-file ((t (:foreground ,darkburn-fg :background ,darkburn-bg :weight normal))))
   `(helm-ff-executable ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg :weight normal))))
   `(helm-ff-invalid-symlink ((t (:foreground ,darkburn-red :background ,darkburn-bg :weight bold))))
   `(helm-ff-symlink ((t (:foreground ,darkburn-yellow :background ,darkburn-bg :weight bold))))
   `(helm-ff-prefix ((t (:foreground ,darkburn-bg :background ,darkburn-yellow :weight normal))))
   `(helm-grep-cmd-line ((t (:foreground ,darkburn-cyan :background ,darkburn-bg))))
   `(helm-grep-file ((t (:foreground ,darkburn-fg :background ,darkburn-bg))))
   `(helm-grep-finish ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg))))
   `(helm-grep-lineno ((t (:foreground ,darkburn-fg-1 :background ,darkburn-bg))))
   `(helm-grep-match ((t (:foreground nil :background nil :inherit helm-match))))
   `(helm-grep-running ((t (:foreground ,darkburn-red :background ,darkburn-bg))))
   `(helm-moccur-buffer ((t (:foreground ,darkburn-cyan :background ,darkburn-bg))))
   `(helm-mu-contacts-address-face ((t (:foreground ,darkburn-fg-1 :background ,darkburn-bg))))
   `(helm-mu-contacts-name-face ((t (:foreground ,darkburn-fg :background ,darkburn-bg))))
;;;;; hl-line-mode
...
;;;;; linum-mode
   `(linum ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg))))
;;;;; macrostep
   `(macrostep-gensym-1
...
;;;;; mic-paren
   `(paren-face-match ((t (:foreground ,darkburn-cyan :background ,darkburn-bg :weight bold))))
...
;;;;; proofgeneral
   ...
   `(proof-tacticals-name-face ((t (:inherit font-lock-constant-face :foreground nil :background ,darkburn-bg))))
   `(proof-tactics-name-face ((t (:inherit font-lock-constant-face :foreground nil :background ,darkburn-bg))))
...
;;;;; emacs-w3m
   ...
   `(w3m-lnum ((t (:foreground ,darkburn-green+2 :background ,darkburn-bg))))
...
;;;;; web-mode
   ...
   `(web-mode-server-background-face ((t (:background ,darkburn-bg))))
...
;;;;; whitespace-mode
   ...
   `(whitespace-line ((t (:background ,darkburn-bg :foreground ,darkburn-magenta))))
